  ...
  <div class="row justify-content-center">
      <div class="col-lg-10">
          <div class="card">
              <div class="card-body">
                  <h5 class="card-title">
                      <center>Saisir les informations de la zone</center>
                  </h5>
                  ...
                  <!-- Formulaire Zone -->
                  <form action="../test/ajout_zone.php" method="POST">

                      <!-- Nom de la zone -->
                      <div class="row mb-3">
                          <label for="zoneNom" class="col-sm-2 col-form-label">Nom de la Zone</label>
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="zoneNom" name="nom" required>
                          </div>
                      </div>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                              <input type="number" class="form-control" id="zonePositifs" name="nb_positifs" required>
                          </div>
                      </div>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                              <input type="number" class="form-control" id="zoneSymptomatiques" name="nb_symptomatiques" required>
                          </div>
                      </div>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                              <input type="number" class="form-control" id="zoneHabitants" name="nb_habitants" required>
                          </div>
                      </div>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                              ...
                              <select class="form-control" id="zonePays" name="pays_id">
                                  ...
                                  <?php
                                  // Afficher les pays existants
                                  foreach ($paysList as $pays) {
                                      echo "<option value='" . $pays->getId() . "'>" . htmlspecialchars($pays->getNom()) . "</option>";
                                  }
                                  ?>
                              </select>
                      ...
                      <div class="row mb-3">
                          <div class="col-sm-10 offset-sm-2">
                              <button type="submit" class="btn btn-primary">Ajouter la Zone</button>
                          </div>
                      </div>
