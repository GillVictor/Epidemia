...
if (!$pointId) {
  header("Location: gestion_pays.php?error=Aucun point sélectionné");
  exit;
}
...
<head>
  ...
  <title>Points de Surveillance / Modifier </title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Modifier - Point</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">
                <center>Modifier un point de surveillance</center>
              </h5>

              <!-- Formulaire Point de Surveillance -->
              <form action="../test/modification_point_surveillance.php" method="POST">
                <div class="row mb-3">
                  <label for="inputNom" class="col-sm-2 col-form-label">Nom</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNom" name="nom" value="<?= htmlspecialchars($point->getNom()) ?>" required>
                  </div>
                </div>

                <!-- Sélection de la zone avec la zone déjà sélectionnée -->
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" id="zoneSelect" name="zone_id" required>
                      ...
                      foreach ($zones as $zone) :
                        $selected = $zone->getId() === $point->getZone()->getId() ? 'selected' : '';
                      ?>
                        <option value="<?= htmlspecialchars($zone->getId()) ?>" <?= $selected ?>>
